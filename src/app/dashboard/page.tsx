          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-lg p-6 shadow">
                <p className="text-gray-600 text-sm mb-1">Average Fit Score</p>
                <p className="text-4xl font-bold text-blue-600">{stats.avg}%</p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow">
                <p className="text-gray-600 text-sm mb-1">Strong Fits (75%+)</p>
                <p className="text-4xl font-bold text-green-600">{stats.strong}</p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow">
                <p className="text-gray-600 text-sm mb-1">Moderate (50-75%)</p>
            ...
            <div className="space-y-3">
              {recentAssessments.map((a) => (
                <Link key={a.id} href={"/assessment/" + a.id}>
                  <div className="bg-white rounded-lg p-4 shadow hover:shadow-md hover:border-blue-400 transition cursor-pointer border-2 border-transparent">
