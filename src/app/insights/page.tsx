      ...
      <div className="container-main py-8">
        <div className="bg-white rounded-lg p-8 shadow">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg"><p className="font-bold">ðŸ“Š Market Insights</p></div>
            <div className="p-4 bg-green-50 rounded-lg"><p className="font-bold">ðŸŽ¯ Competitor Analysis</p></div>
            <div className="p-4 bg-purple-50 rounded-lg"><p className="font-bold">ðŸŽ¤ Interview Prep</p></div>
            <div className="p-4 bg-yellow-50 rounded-lg"><p className="font-bold">ðŸ’° Salary Intelligence</p></div>
          </div>
        </div>
      </div>
    </div>
